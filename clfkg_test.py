...
class CLFKG(nn.Module):    
    def __init__(self, dropout=0.1):
        super(CLFKG, self).__init__()
        #### hfl/chinese-bert-wwm 
        #### for Rumour TexT
        self.bert_text = BertModel.from_pretrained('YidaM4396/BERT_Weibo_Rumor')   
        self.bert_kg = nn.Linear(768, 128)     
        #### for Description
        self.bert_desc = BertModel.from_pretrained('YidaM4396/BERT_Weibo_Rumor')        
        ### for USER FEATURES
